...
sys.path.append('../')
import torch
from arch.PUF3D8x import Generator
...
def train(args):
    ...
    for e in range(120):
        ...
        if Bestacc < top1.avg:
            Bestacc = top1.avg
            torch.save(G_model.state_dict(), './savedModel/PUF3DDGCNN8x_abs2.parm')
        ...
        data_frame.to_csv(out_path + 'PUF3DDGCNN8x_abs2' + '.csv', index_label='Epoch')
