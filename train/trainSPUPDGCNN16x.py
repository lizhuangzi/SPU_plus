...
sys.path.append('../')
import torch
from arch.PUF3D16x import Generator
...
def train(args):
    ...
    for e in range(120):
        ...
        if Bestacc < top1.avg:
            Bestacc = top1.avg
            torch.save(G_model.state_dict(), './savedModel/PUF3DDGCNN16x.parm')
        ...
        data_frame.to_csv(out_path + 'PUF3DDGCNN16x' + '.csv', index_label='Epoch')
