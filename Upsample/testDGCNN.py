...
from Upsample.PUF3D8xssup import Generator
...
if __name__ == '__main__':
    ...
    test_loader = DataLoader(eval_dst, batch_size=10,
    ...
    G_model.load_state_dict(torch.load('./savedModel/PUF3D_Mid8x_ssup.parm'))
    G_model.cuda()
