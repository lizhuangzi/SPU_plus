...
sys.path.append('../')
import torch
from Upsample.PUF3D8xfspnoscaling import Generator
...
def train(args):
    ...
    for e in range(120):
        ...
        if Bestacc < top1.avg:
            Bestacc = top1.avg
            torch.save(G_model.state_dict(), './savedModel/PUF3DDGCNN_Pre8xfspnoscaling.parm')
        ...
        data_frame.to_csv(out_path + 'PUF3DDGCNN_Pre8xfspnoscaling' + '.csv', index_label='Epoch')
