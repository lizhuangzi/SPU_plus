...
from arch.PixelShuffle1D import SpatialShuffle,SpatialShuffle_pluswoabs,SpatialShuffle_plus
import numpy as  np
...
class SEPS(nn.Module):
    def __init__(self,inchannel,outchannel = 256,up_ratio=4):
        ...
        self.upshuffle = SpatialShuffle_pluswoabs(self.up_ratio // 2,inchannel=2*outchannel)
