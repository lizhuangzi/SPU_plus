...
from data.ModelNet40SPU import ModelNet40spu_plus,ModelNet40spu
import time
...
def train(args):
    ...
    for e in range(120):
        ...
        if Bestacc < top1.avg:
            Bestacc = top1.avg
            torch.save(G_model.state_dict(), './savedModel/PUF3DDGCNN_Pre16xfspnoscaling.parm')
        ...
        data_frame.to_csv(out_path + 'PUF3DDGCNN_Pre16xfspnoscaling' + '.csv', index_label='Epoch')
