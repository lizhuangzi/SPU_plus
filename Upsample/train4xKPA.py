...
sys.path.append('../')
import torch
from Upsample.PUF3D4xfspKPA import Generator
...
def train(args):
    ...
    for e in range(120):
        ...
        if Bestacc < top1.avg:
            Bestacc = top1.avg
            torch.save(G_model.state_dict(), './savedModel/PUF3D_Pre4x_fsupKPA.parm')
        ...
        #pre4 x2 88.3
        data_frame.to_csv(out_path + 'PUF3D_Pre4x_fsupKPA' + '.csv', index_label='Epoch')
